...
<body class="font-sans bg-gray-100">
    ...
    <header 
    style="background-image: url('/images/bg3.jfif'); background-size: cover; background-position: center; background-repeat: no-repeat; height: 500px;" 
        ...
        <div class="flex justify-center mt-8">
            <div class="relative w-1/2">
                ...
                class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <button 
                    type="submit" 
                    class="absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
                    Search
                    </button>
            </div>
        </div>
        ...
        <div class="container mx-auto mt-8">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6 flex">
                <div style="width: 300px;">
                    <img src="/images/image1.jfif" alt="Image 1" class="object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6 flex">
                <div style="width: 300px;">
                    <img src="/images/image2.jfif" alt="Image 2" class="object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6 flex">
                <div style="width: 300px;">
                    <img src="/images/image3.jfif" alt="Image 2" class="object-cover">
                </div>
                <div class="p-6">
...
<?php /**PATH D:\Nathan\Binus\Semester 5\Web Programming\MentalHealth\resources\views/home.blade.php ENDPATH**/ ?>