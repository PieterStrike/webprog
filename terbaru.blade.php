        ...
        <div class="container mx-auto mt-8">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6 flex">
                <div style="width: 300px;">
                    <img src="/images/foto.png" alt="Image 1" class="object-cover">
                </div>
                <div class="p-6">
                    <h2 class="text-xl font-semibold text-gray-800">Kasus Mental Health Meningkat, Dosen UMM Jelaskan</h2>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6 flex">
                <div style="width: 300px;">
                    <img src="/images/foto2.png" alt="Image 2" class="object-cover">
                </div>
                <div class="p-6">
                    <h2 class="text-xl font-semibold text-gray-800">Pentingnya Kesehatan Mental pada Remaja</h2>
                    <p class="text-gray-600 mt-2">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore...
                    </p>
                </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6 flex">
                <div style="width: 300px;">
                    <img src="/images/foto3.png" alt="Image 2" class="object-cover">
                </div>
                <div class="p-6">
                    <h2 class="text-xl font-semibold text-gray-800">Pemicu Gangguan Mental Jika Seharian Di Rumah</h2>
                    <p class="text-gray-600 mt-2">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore...
                    </p>
                </div>
